    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-white">
      ...
      <main>
        <div className="relative">
          ...
          <div className="container mx-auto px-6 md:px-0 lg:px-0 pb-20">
            <div className="relative z-10 grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 lg:col-span-6 lg:flex lg:justify-center pt-10">
                <div className="w-[80%]">
                  ...
                  {/* Connect section between Projects and About - 95% width */}
              ...
              <div className="col-span-12 lg:col-span-3 lg:col-end-12 pt-10 md:pt-20">

...
const Index = () => {
  return <div className="min-h-screen bg-gradient-to-b from-gray-900/80 to-gray-950/80 text-white relative overflow-hidden">
      ...
      <main id="main-content">
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-gray-900/80 to-transparent" />

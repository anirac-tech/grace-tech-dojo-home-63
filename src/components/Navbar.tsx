  ...
  return (
    <header 
      className={cn(
        ...
        isScrolled ? "backdrop-blur-xl bg-gray-900/90 shadow-lg shadow-black/10 py-3" : "bg-transparent py-5"
      )}
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="md:hidden p-2 focus:outline-none focus:ring-2 focus:ring-dojo-300 rounded-md" 
            ...
            {navLinks.map(link => (
              <Link 
                ...
                className={cn(
                  ...
                  activeLink === link.path ? "text-dojo-300 border-dojo-300/30" : "text-gray-300 hover:text-dojo-300"
                )} 

...
const CommunitySection = () => {
  return (
    <section className="bg-white dark:bg-gray-900 transition-colors duration-300" id="community">
      <div className="container mx-auto px-8 md:px-12 lg:px-24 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-10 leading-relaxed transition-colors duration-300">

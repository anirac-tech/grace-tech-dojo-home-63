...
const ConnectSection = () => {
  return (
    <section className="bg-gradient-to-b from-white to-gray-50" id="connect">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100">
            <div className="flex items-center mb-6">
              <div className="bg-dojo-50 p-3 rounded-full mr-4">
                <MessageSquare className="h-6 w-6 text-dojo-600" />
              </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100">
            <div className="flex items-center mb-6">
              <div className="bg-dojo-50 p-3 rounded-full mr-4">
                <Users className="h-6 w-6 text-dojo-600" />
              </div>
              <h3 className="text-xl font-serif font-semibold text-gray-800">
                Join Our Community
              </h3>

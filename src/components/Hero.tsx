...
const Hero = () => {
  ...
  return <section className="flex items-center pt-20 pb-28 overflow-hidden">
      ...
      <div className="relative z-10 w-[calc(100%-30px)]">
        <div style={dynamicTransform} className="transition-transform duration-200 ease-out mx-[48px]">
          <h1 className={`text-4xl sm:text-5xl md:text-6xl font-serif font-semibold text-white mb-8 leading-tight tracking-tight transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className={`w-1/3 h-0.5 bg-dojo-300 mb-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 w-1/3' : 'opacity-0 w-0'}`} />

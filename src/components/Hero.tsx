...
const Hero = () => {
  ...
  return <section className="flex items-center pt-20 pb-12 overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6">
        <div style={dynamicTransform} className="transition-transform duration-200 ease-out mx-auto">
          <div className="flex flex-col">
            <h1 id="hero-heading" className={`text-4xl sm:text-5xl md:text-6xl font-serif font-semibold text-white mb-8 leading-tight tracking-tight transition-all duration-1000 text-left ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className={`text-lg md:text-xl text-gray-300 mb-2 leading-relaxed transition-all duration-1000 delay-500 text-right ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>

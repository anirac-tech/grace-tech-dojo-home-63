...
const ProjectCard = ({ title, description, url, linkText = "View Project" }: ProjectCardProps) => {
  ...
  return (
    <Card 
      className="h-full transition-all duration-300 hover:shadow-xl hover:shadow-dojo-300/10 border border-gray-700/50 dark:border-gray-700 rounded-lg overflow-hidden group bg-gradient-to-b from-gray-800/80 to-gray-900/90 backdrop-blur-md transform-gpu"
    ...
    >
      ...
      <CardContent className="flex-grow flex flex-col p-3 transition-colors duration-300 relative">
        ...
        <div 
          className="absolute -bottom-10 -right-10 w-20 h-20 rounded-full bg-dojo-300/5 transition-opacity duration-300 opacity-0 group-hover:opacity-100"
          style={{
